# GetErlangInstallerCommand Constructor 
 _**\[This is preliminary documentation and is subject to change.\]**_

Initializes a new instance of the <a href="T_Thycotic_RabbitMq_Helper_PSCommands_Installation_GetErlangInstallerCommand">GetErlangInstallerCommand</a> class
...
**C#**<br />
``` C#
public GetErlangInstallerCommand()
```
