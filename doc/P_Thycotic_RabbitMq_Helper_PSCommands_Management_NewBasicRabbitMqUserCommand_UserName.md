# NewBasicRabbitMqUserCommand.UserName Property 
...
#### Property Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a><br />The name of the rabbit mq user.
