...
Scenario: An empty queue should be empty
	...
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
...
Scenario: Adding to empty queue
	...
	And item 8 is enqueued in the scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
	Then the string join of scenario integer array ConcurrentPriorityQueueResults should be "2 4 8"
...
Scenario: Adding to empty queue with priority
	...
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
	Then the string join of scenario integer array ConcurrentPriorityQueueResults should be "8 4 2"
...
Scenario: Adding and removing from queue
	...
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
	Then the string join of scenario integer array ConcurrentPriorityQueueResults should be "4 8"
...
Scenario: Removing from empty queue
	Given there exists an integer ConcurrentPriorityQueue stored in the scenario as ConcurrentPriorityQueueTest
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
	Then the string join of scenario integer array ConcurrentPriorityQueueResults should be ""

Scenario: Removing from queue with a single item
	Given there exists an integer ConcurrentPriorityQueue stored in the scenario as ConcurrentPriorityQueueTest
	And item 2 is enqueued in the scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest
	When all items are dequeued from scenario integer ConcurrentPriorityQueue ConcurrentPriorityQueueTest and stored in scenario integer array ConcurrentPriorityQueueResults
	Then the string join of scenario integer array ConcurrentPriorityQueueResults should be "2"
