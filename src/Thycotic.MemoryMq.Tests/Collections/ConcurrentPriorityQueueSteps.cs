...
namespace Thycotic.MemoryMq.Tests.Collections
{
    ...
    public class ConcurrentPriorityQueueSteps
    {
        ...
        [Given(@"the scenario object ConcurrentPriorityQueue (\w+) is empty")]
        ...
        [Given(@"the scenario object ConcurrentPriorityQueue (\w+) is not empty")]
        ...
        [Given(@"item (\d+) is enqueued in the scenario object ConcurrentPriorityQueue (\w+)")]
        ...
        [Given(@"item is dequeued in the scenario object ConcurrentPriorityQueue (\w+)")]
        ...
        [Given(@"item (\d+) is priorty enqueued in the scenario object ConcurrentPriorityQueue (\w+)")]
        ...
        [When(@"all items are dequeued from scenario object ConcurrentPriorityQueue (\w+) and stored in scenario object array (\w+)")]
        ...
        [Then(@"the scenario object ConcurrentPriorityQueue (\w+) should be empty")]
        ...
        [Then(@"the scenario object ConcurrentPriorityQueue (\w+) should not be empty")]
