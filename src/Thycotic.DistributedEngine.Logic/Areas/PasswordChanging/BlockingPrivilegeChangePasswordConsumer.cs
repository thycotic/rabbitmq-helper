...
{
    /// <summary>
    /// Secret change password (using privileged credentials) blocking request
    /// </summary>
    public class BlockingPrivilegeChangePasswordConsumer : IBlockingConsumer<BlockingPrivilegedPasswordChangeMessage, BlockingPasswordChangeResponse>
    {
        ...
        public BlockingPrivilegeChangePasswordConsumer(IResponseBus responseBus)
        {
        ...
        public BlockingPasswordChangeResponse Consume(CancellationToken token, BlockingPrivilegedPasswordChangeMessage request)
        {
            _log.Info("Got a privileged change password verify request.");
