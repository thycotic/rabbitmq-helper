...
namespace Thycotic.RabbitMq.Helper.PSCommands
{
    ...
    internal static class CmdletUacExtensions
    {
        public static void RequireRunningWithElevated(this Cmdlet cmdlet)
        {
            if (!UacHelper.IsProcessElevated)
            {
                cmdlet.ThrowTerminatingError(
                    new ErrorRecord(new UnauthorizedAccessException("This cmdlet requires elevation"), string.Empty,
                        ErrorCategory.AuthenticationError, cmdlet));
            }
        }
    }
}