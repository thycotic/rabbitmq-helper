...
Scenario: Serialize object
	Given there exists an object of type "Thycotic.Utility.Tests.DummyObject, Thycotic.Utility.Tests" stored in the scenario as JsonObjectSerializerTestObject
...
Scenario: Deserialize object
	...
	When the scenario object JsonObjectSerializerTestObjectBytes is turned into an object of type "Thycotic.Utility.Tests.DummyObject, Thycotic.Utility.Tests" and stored in the scenario as JsonObjectSerializerTestObject2
