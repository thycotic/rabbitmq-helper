...
namespace Thycotic.MessageQueueClient.Wrappers.MemoryMq
{
    ...
    public class BasicMemoryMqConsumerWrapper<TRequest, THandler> : RabbitMqConsumerWrapperBase<TRequest, THandler>
        ...
        where THandler : IBasicConsumer<TRequest>
    {
        ...
        public BasicMemoryMqConsumerWrapper(IRabbitMqConnection rmq, IMessageSerializer serializer, Func<Owned<THandler>> handlerFactory)
            : base(rmq)
        {
