...
namespace Thycotic.MessageQueueClient.Wrappers.MemoryMq
{
    ...
    public class BlockingMemoryMqConsumerWrapper<TRequest, TResponse, THandler> : RabbitMqConsumerWrapperBase<TRequest, THandler>
        ...
        where THandler : IBlockingConsumer<TRequest, TResponse>
    {
        ...
        public BlockingMemoryMqConsumerWrapper(IRabbitMqConnection rmq, IMessageSerializer serializer, Func<Owned<THandler>> handlerFactory)
            : base(rmq)
        {
