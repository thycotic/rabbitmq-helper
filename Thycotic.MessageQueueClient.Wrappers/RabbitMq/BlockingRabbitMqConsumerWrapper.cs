...
namespace Thycotic.MessageQueueClient.Wrappers.RabbitMq
{
    ...
    public class BlockingRabbitMqConsumerWrapper<TRequest, TResponse, THandler> : BlockingConsumerWrapper<TRequest, TResponse, THandler>, IBasicConsumer
        ...
        where THandler : IBlockingConsumer<TRequest, TResponse>
    {
        ...
        public BlockingRabbitMqConsumerWrapper(ICommonConnection connection, IMessageSerializer serializer, Func<Owned<THandler>> handlerFactory)
