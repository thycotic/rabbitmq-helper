...
Scenario: Deserialize object
	...
	When the scenario object MessageSerializerTestObjectBytes is turned into an object of type "Thycotic.Messages.Common.RpcResult, Thycotic.Messages.Common" and stored in the scenario as MessageSerializerTestObject2
